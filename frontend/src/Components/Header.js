...
const Header = () => {
  ...
  return (
    <div className="grid grid-flow-col p-2 m-2 shadow-lg shadow-blue-950 bg-gray-50">
        ...
        <img className="h-28 px-4 mx-4 rounded-full " alt="logo" src={logo} onClick={handleClick} />
        <input className='border-4 border-gray-400 p-4 h-10 w-80 mt-10 rounded-l-full' type="text" placeholder='Serach' ></input>
