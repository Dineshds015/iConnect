...
const Header = () => {
  ...
  return (
    <div className="grid grid-flow-col p-2 m-2 shadow-lg shadow-blue-950 bg-gray-50">
        ...
        <input className='border-2 border-gray-400 p-4 h-7 w-80 mt-7 rounded-l-full' type="text" placeholder='Serach' ></input>
        <span className='mt-7 border-2 border-gray-400 h-9 rounded-r-full py-2 px-2'>🔍</span>
        </div>
        <div className="flex col-span-8 h-20 justify-self-end">
