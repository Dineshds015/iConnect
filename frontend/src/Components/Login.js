  ...
  return (
    <div className="flex flex-row justify-center shadow-lg">
        ...
        <div className='flex flex-col justify-center m-10 mt-44'>
            ...
            <button className='mx-4 px-4 my-2 border border-solid w-96 h-12 rounded-full bg-teal-300 text-2xl flex items-center justify-center' type = "submit"  onc><img className='h-8 border border-solid mr-2' src='https://cdn.worldvectorlogo.com/logos/linkedin-icon-2.svg' alt='LinkedIn Logo' />Login In with LinkedIn</button>
